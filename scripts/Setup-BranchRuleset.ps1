...
param(
    [Parameter()]
    [string]$Repository = "@Chris-Wolfgang/ETL-Transformers",
...
if ($Repository -eq "@Chris-Wolfgang/ETL-Transformers" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "@Chris-Wolfgang/ETL-Transformers") {
